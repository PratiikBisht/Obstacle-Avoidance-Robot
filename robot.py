...
class Robot:
    ...
    def avoid_obsatcles(self,point_cloud, dt):
       closest_obs=0
       dist= np.inf
...
class Graphics:
    def __init__(self ,  dimension, robot_img_path, map_img_path):
        pygame.init()
        ...
        #loading image
        self.robot= pygame.iamge.load(robot_img_path)
        ...
        #window setting s
        pygame.dispaly.set_caption("Obstacle avoidance ")
...
class Ultrasonic:
    def __init__(self, sensor_range, mao):
